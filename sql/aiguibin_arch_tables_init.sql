...
CREATE TABLE biz_approval_log (
    ...
    before_status VARCHAR(32) COMMENT '操作前状态',
...
('90004', '赵六', '赵六', 2, 
 ...
 NULL, NULL, NULL, 0, 1, 0, NULL, NULL, 0, '2026-12-31 23:59:59', NOW(), 'administrator', NOW(), NULL, NULL, 0),
('liuguibin', '刘贵斌', 'guibin', 1, 
 '$2a$10$abcdefghijklmnopqrstuvwxyz0123456789abcdefghijklmnopq', 
 'abcdefghijklmnopqrstuvwx', '01000', '01000D001', 'liuguibin@example.com', '13800138005', 
 NULL, NULL, NULL, 0, 1, 0, NULL, NULL, 0, '2026-12-31 23:59:59', NOW(), 'administrator', NOW(), NULL, NULL, 0);
...
('liuguibin', '01000', 1, '研发工程师', '2024-01-01', '2026-12-31', 1, '总部主机构', 'administrator', NOW(), NULL, NULL, 0);
...
('liuguibin', '01000D001', 1, '研发工程师', '2024-01-01', '2026-12-31', 1, '总部研发部主部门', 'administrator', NOW(), NULL, NULL, 0);
...
('liuguibin', 'R0003', 1, '2024-01-01', '2026-12-31', 1, '刘贵斌作为开发工程师', 'administrator', NOW(), NULL, NULL, 0);
...
('P0000006', '字典管理', 2, 'M0000003', NULL, '/system-settings/dicts', 'views/DictManagement', NULL, NULL, 0, 1, 1, 'dict:management', 4, 1, '字典管理页面', 'administrator', NOW(), NULL, NULL, 0),
('P0000007', '操作日志', 2, 'M0000003', NULL, '/system-settings/logs', 'views/OperationLogs', NULL, NULL, 0, 1, 1, 'log:operation', 5, 1, '操作日志页面', 'administrator', NOW(), NULL, NULL, 0);
...
INSERT INTO sys_role_permission (role_code, perm_code, auth_type, effective_start, effective_end, priority, status,
                                 description, created_by, created_time, updated_by, updated_time, is_deleted)
VALUES ('R0002', 'P0001', 1, '2024-01-01', '2026-12-31', 100, 1, '架构师首页权限', 'administrator', NOW(), NULL, NULL, 0),
       ('R0002', 'P0002', 1, '2024-01-01', '2026-12-31', 100, 1, '架构师变更列表权限', 'administrator', NOW(), NULL, NULL, 0),
       ('R0002', 'P0003', 1, '2024-01-01', '2026-12-31', 100, 1, '架构师新增变更权限', 'administrator', NOW(), NULL, NULL, 0),
       ('R0002', 'P0004', 1, '2024-01-01', '2026-12-31', 100, 1, '架构师编辑变更权限', 'administrator', NOW(), NULL, NULL, 0),
       ('R0002', 'P0005', 1, '2024-01-01', '2026-12-31', 100, 1, '架构师删除变更权限', 'administrator', NOW(), NULL, NULL, 0),
       ('R0002', 'P0006', 1, '2024-01-01', '2026-12-31', 100, 1, '架构师导出变更权限', 'administrator', NOW(), NULL, NULL, 0),
       ('R0002', 'P0013', 1, '2024-01-01', '2026-12-31', 100, 1, '架构师查看本机构数据权限', 'administrator', NOW(), NULL, NULL, 0);

-- 13. 为开发工程师角色分配基础权限
INSERT INTO sys_role_permission (role_code, perm_code, auth_type, effective_start, effective_end, priority, status,
                                 description, created_by, created_time, updated_by, updated_time, is_deleted)
VALUES ('R0003', 'P0001', 1, '2024-01-01', '2026-12-31', 100, 1, '开发工程师首页权限', 'administrator', NOW(), NULL, NULL, 0),
       ('R0003', 'P0002', 1, '2024-01-01', '2026-12-31', 100, 1, '开发工程师变更列表权限', 'administrator', NOW(), NULL, NULL, 0),
       ('R0003', 'P0003', 1, '2024-01-01', '2026-12-31', 100, 1, '开发工程师新增变更权限', 'administrator', NOW(), NULL, NULL, 0),
       ('R0003', 'P0004', 1, '2024-01-01', '2026-12-31', 100, 1, '开发工程师编辑变更权限', 'administrator', NOW(), NULL, NULL, 0),
       ('R0003', 'P0014', 1, '2024-01-01', '2026-12-31', 100, 1, '开发工程师查看本人数据权限', 'administrator', NOW(), NULL, NULL, 0);
...
VALUES ('DR00000001', '超级管理员数据规则', 1, 'P0012', 'biz_change_record', 1, 1, NULL, NULL, 1, 1, 1,
        '超级管理员可以查看所有变更数据', 'administrator', NOW(), NULL, NULL, 0),
       ('DR00000002', '架构师数据规则', 1, 'P0013', 'biz_change_record', 2, 1, NULL, NULL, 2, 0, 1,
        '架构师可以查看本机构及下属机构变更数据', 'administrator', NOW(), NULL, NULL, 0),
       ('DR00000003', '开发工程师数据规则', 1, 'P0014', 'biz_change_record', 4, 0, NULL, NULL, 3, 0, 1,
        '开发工程师只能查看自己的变更数据', 'administrator', NOW(), NULL, NULL, 0);
...
VALUES ('CURRENT_STATUS', '当前状态', '变更记录的当前状态', 1, 1, 'administrator', NOW(), NULL, NULL, 0),
       ('DEVELOP_TYPE', '开发类别', '开发任务的类别', 2, 1, 'administrator', NOW(), NULL, NULL, 0),
       ('YES_NO', '是否选项', '通用的是/否选项', 3, 1, 'administrator', NOW(), NULL, NULL, 0),
       ('OPERATION_TYPE', '操作类型', '系统操作类型', 4, 1, 'administrator', NOW(), NULL, NULL, 0);
...
VALUES
-- 当前状态
('CURRENT_STATUS', 'PENDING_APPROVAL', '待审批', NULL, NULL, 1, 1, 'administrator', NOW(), NULL, NULL, 0),
('CURRENT_STATUS', 'PENDING_REVIEW', '待评审', NULL, NULL, 2, 1, 'administrator', NOW(), NULL, NULL, 0),
('CURRENT_STATUS', 'PENDING_MERGE', '待合版', NULL, NULL, 3, 1, 'administrator', NOW(), NULL, NULL, 0),
('CURRENT_STATUS', 'MERGED', '已合版', NULL, NULL, 4, 1, 'administrator', NOW(), NULL, NULL, 0),
('CURRENT_STATUS', 'PENDING_RELEASE', '待发布', NULL, NULL, 5, 1, 'administrator', NOW(), NULL, NULL, 0),
('CURRENT_STATUS', 'RELEASED', '已发布', NULL, NULL, 6, 1, 'administrator', NOW(), NULL, NULL, 0),
('CURRENT_STATUS', 'REJECTED', '已驳回', NULL, NULL, 7, 1, 'administrator', NOW(), NULL, NULL, 0),
('CURRENT_STATUS', 'CANCELLED', '已取消', NULL, NULL, 8, 1, 'administrator', NOW(), NULL, NULL, 0),
-- 开发类别
('DEVELOP_TYPE', 'FRONTEND', '前端', NULL, NULL, 1, 1, 'administrator', NOW(), NULL, NULL, 0),
('DEVELOP_TYPE', 'BACKEND', '后端', NULL, NULL, 2, 1, 'administrator', NOW(), NULL, NULL, 0),
('DEVELOP_TYPE', 'SCRIPT', '脚本', NULL, NULL, 3, 1, 'administrator', NOW(), NULL, NULL, 0),
('DEVELOP_TYPE', 'CONFIG', '配置', NULL, NULL, 4, 1, 'administrator', NOW(), NULL, NULL, 0),
('DEVELOP_TYPE', 'DATABASE', '数据库', NULL, NULL, 5, 1, 'administrator', NOW(), NULL, NULL, 0),
('DEVELOP_TYPE', 'OTHER', '其他', NULL, NULL, 6, 1, 'administrator', NOW(), NULL, NULL, 0),
-- 是否选项
('YES_NO', '1', '是', NULL, NULL, 1, 1, 'administrator', NOW(), NULL, NULL, 0),
('YES_NO', '0', '否', NULL, NULL, 2, 1, 'administrator', NOW(), NULL, NULL, 0),
-- 操作类型
('OPERATION_TYPE', 'CREATE', '创建', NULL, NULL, 1, 1, 'administrator', NOW(), NULL, NULL, 0),
('OPERATION_TYPE', 'UPDATE', '更新', NULL, NULL, 2, 1, 'administrator', NOW(), NULL, NULL, 0),
('OPERATION_TYPE', 'DELETE', '删除', NULL, NULL, 3, 1, 'administrator', NOW(), NULL, NULL, 0),
('OPERATION_TYPE', 'APPROVE', '审批', NULL, NULL, 4, 1, 'administrator', NOW(), NULL, NULL, 0),
('OPERATION_TYPE', 'REJECT', '驳回', NULL, NULL, 5, 1, 'administrator', NOW(), NULL, NULL, 0),
('OPERATION_TYPE', 'LOGIN', '登录', NULL, NULL, 6, 1, 'administrator', NOW(), NULL, NULL, 0),
('OPERATION_TYPE', 'LOGOUT', '登出', NULL, NULL, 7, 1, 'administrator', NOW(), NULL, NULL, 0),
('OPERATION_TYPE', 'EXPORT', '导出', NULL, NULL, 8, 1, 'administrator', NOW(), NULL, NULL, 0);

-- 17. 初始化业务类型注册表
DELETE FROM biz_business_type;
INSERT INTO biz_business_type (type_code, type_name, main_table_name, id_field_name, code_field_name, status_field_name, title_field_name, is_active, description, created_by, created_time, updated_by, updated_time, is_deleted)
VALUES ('CHANGE_RECORD', '变更记录', 'biz_change_record', 'id', 'record_code', 'current_status', 'change_desc', 1, '变更记录业务类型', 'administrator', NOW(), NULL, NULL, 0);

-- 18. 初始化审批流程定义
DELETE FROM biz_approval_flow;
INSERT INTO biz_approval_flow (flow_id, flow_name, business_type, description, is_active, is_default, created_by, created_time, updated_by, updated_time, is_deleted)
VALUES ('FLOW_CHG_001', '变更记录审批流程', 'CHANGE_RECORD', '变更记录的标准审批流程', 1, 1, 'administrator', NOW(), NULL, NULL, 0);

-- 19. 初始化审批节点定义
DELETE FROM biz_approval_node;
INSERT INTO biz_approval_node (node_id, flow_id, node_name, node_order, node_type, approver_num, approver_name, is_active, created_by, created_time, updated_by, updated_time, is_deleted)
VALUES ('NODE_TECH_REVIEW', 'FLOW_CHG_001', '技术评审', 1, 'NORMAL', '90004', '赵六', 1, 'administrator', NOW(), NULL, NULL, 0),
       ('NODE_MANAGER_APPROVE', 'FLOW_CHG_001', '经理审批', 2, 'NORMAL', '90001', '张三', 1, 'administrator', NOW(), NULL, NULL, 0),
       ('NODE_FINAL_APPROVE', 'FLOW_CHG_001', '最终审批', 3, 'END', 'administrator', '超级管理员', 1, 'administrator', NOW(), NULL, NULL, 0);

-- 20. 初始化变更记录示例数据
DELETE FROM biz_change_record;
